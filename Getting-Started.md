...
Since your core grade is directly related to how well each function is implemented, we **highly encourage** the use of a test suite just like you've done for previous projects and assignments. We have included a sample test suite to help you test your board.cpp functions. To setup your project for running the test suite, follow the same instructions as in the previous section [Project Setup for Core](Getting started#Project Setup for Core) above except that instead of adding main.cpp to your project you should add test_board.cpp. 
