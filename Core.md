...
* **board.h**: Declarations of global constant variables, functions for the Board class, and enums used throughout the project. Enumerators, also known as 'enums', are explained below for you. _**It is absolutely pivotal that you DO NOT edit this file for autograder purposes**_
...
* **connect4.h**: Declarations of functions to read a board from a file and to write a board to a file along with the function that facilitates playing via terminal (console). _**It is absolutely pivotal that you DO NOT edit this file for autograder purposes**_
...
* **graphics.h**: Declarations of functions used for the graphics part of the project. _**It is absolutely pivotal that you DO NOT edit this file for autograder purposes**_
